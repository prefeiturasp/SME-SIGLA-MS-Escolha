...
class EscolhaSerializer(DynamicFieldsSerializer):
    ...
    # Campo customizado para aceitar UUID da vaga_escola e converter para ForeignKey  # noqa: E501
    ...
    def validate(self, attrs):
        ...
        # Para atualizações parciais, usar valores do instance se não estiverem em attrs  # noqa: E501
        if self.instance:
        ...
        if vaga_escola_uuid and not vaga_escola:
            try:
                ...
                raise serializers.ValidationError(  # noqa: B904
                    {
                        "vaga_escola_uuid": f"VagaEscola com UUID {vaga_escola_uuid} não encontrada."  # noqa: E501
                    }
                )
