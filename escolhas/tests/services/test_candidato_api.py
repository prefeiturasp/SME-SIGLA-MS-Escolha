...
class TestCandidatoAPIService:
    ...
    def test_buscar_candidatos_por_cpfs_sucesso(self, settings: Any) -> None:
        ...
        mock_response_data = [{'uuid': 'candidato-uuid-1', 'cpf': '12345678901', 'nome': 'Candidato 1'}, {'uuid': 'candidato-uuid-2', 'cpf': '98765432100', 'nome': 'Candidato 2'}]
        with patch('sigla_sdk.http.api_client.http_client.post') as mock_post:
            ...
            assert call_args[1]['json'] == {'processo_uuid': processo_uuid, 'cpfs': cpfs}
    ...
    def test_buscar_candidatos_sucesso(self, settings: Any) -> None:
        ...
        settings.CANDIDATOS_API_URL = 'http://test-api.com'
        service = CandidatoAPIService()
        mock_response_data = [{'nome': 'João', 'cpf': '12345678901', 'concursos': []}]
    ...
    def test_buscar_candidatos_envia_params_corretos(self, settings: Any) -> None:
        ...
        with patch('sigla_sdk.http.api_client.http_client.get') as mock_get:
            ...
            mock_response.raise_for_status.return_value = None
            mock_get.return_value = mock_response
            service.buscar_candidatos(nome='Maria', cpf='11122233344', rg='12.345.678-9', registro_funcional='RF001')
            call_args = mock_get.call_args
