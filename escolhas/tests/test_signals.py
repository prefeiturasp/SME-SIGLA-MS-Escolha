...
class TestEscolhaSignals:
    ...
    def test_signal_decrementa_vaga_definitiva_ao_criar_escolha(self, vaga_escola_com_vagas):
    ...
    def test_signal_decrementa_vaga_precaria_ao_criar_escolha(self, escola, lote):
    ...
    def test_signal_nao_decrementa_se_situacao_nao_for_escolha(self, escola, lote):
    ...
    def test_signal_nao_decrementa_se_vaga_escola_uuid_nao_fornecido(self, vaga_escola_com_vagas):
    ...
    def test_signal_nao_decrementa_se_tipo_vaga_nao_fornecido(self, vaga_escola_com_vagas):
    ...
    def test_signal_decrementa_multiplas_escolhas_sequencialmente(self, escola, lote):
    ...
    def test_signal_nao_decrementa_em_atualizacao_apenas_em_criacao(self, escola, lote):
