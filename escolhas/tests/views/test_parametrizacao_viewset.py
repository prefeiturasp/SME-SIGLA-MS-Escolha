...
MAPPING_FIXTURE = [('CCA', 'cca'), ('CCI/CIPS', 'ccicips'), ('CECI', 'ceci'), ('CEI DIRET', 'cei-diret'), ('CEI INDIR', 'cei-indir'), ('CEMEI', 'cemei'), ('CEU AT COMPL', 'ceu-at-compl'), ('CEU CEI', 'ceu-cei'), ('CEU CEMEI', 'ceu-cemei'), ('CEU EMEF', 'ceu-emef'), ('CEU EMEI', 'ceu-emei'), ('CEU POLO', 'ceu-polo'), ('CIEJA', 'cieja'), ('CMCT', 'cmct'), ('CR.P.CONV', 'crpconv'), ('EMEBS', 'emebs'), ('EMEF', 'emef'), ('EMEFM', 'emefm'), ('EMEF P FOM', 'emef-p-fom'), ('EMEI', 'emei'), ('EMEI P FOM', 'emei-p-fom'), ('ESC.PART.', 'escpart'), ('ESP CONV', 'esp-conv'), ('E TEC', 'e-tec'), ('MOVA', 'mova')]
...
def test_bulk_update_usar_updates_multiple(api_client: Any, parametrizacoes_db: Any) -> None:
    ...
    payload = [{'uuid': str(p1.uuid), 'usar': True}, {'uuid': str(p2.uuid), 'usar': True}]
