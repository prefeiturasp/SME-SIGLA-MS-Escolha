...
def dres_criadas() -> Any:
    ...
    """
    return [Dre.objects.create(codigo='108100', nome='DIRETORIA REGIONAL DE EDUCACAO BUTANTA', sigla='DRE - BT'), Dre.objects.create(codigo='108200', nome='DIRETORIA REGIONAL DE EDUCACAO IPIRANGA', sigla='DRE - IP'), Dre.objects.create(codigo='108300', nome='DIRETORIA REGIONAL DE EDUCACAO PENHA', sigla='DRE - PE')]
...
class TestDreViewSet:
    ...
    def test_list_com_dados(self, api_client: Any, dres_criadas: Any) -> None:
        ...
        Args:
            self: Instância do objeto.
            api_client: Cliente de API para requisições de teste.
            dres_criadas: Parâmetro dres criadas da operação.
    ...
    def test_pagination(self, api_client: Any) -> None:
        ...
        """
        for i in range(1, 12):
            Dre.objects.create(codigo=f'108{i:02d}00', nome=f'DRE {i:02d}', sigla=f'DRE - {i:02d}')
        url = reverse('dre-list')
