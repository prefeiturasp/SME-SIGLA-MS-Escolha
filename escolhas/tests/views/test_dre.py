...
def dres_criadas():
    return [
        Dre.objects.create(codigo='108100', nome='DIRETORIA REGIONAL DE EDUCACAO BUTANTA', sigla='DRE - BT'),
        Dre.objects.create(codigo='108200', nome='DIRETORIA REGIONAL DE EDUCACAO IPIRANGA', sigla='DRE - IP'),
        Dre.objects.create(codigo='108300', nome='DIRETORIA REGIONAL DE EDUCACAO PENHA', sigla='DRE - PE'),
    ]
