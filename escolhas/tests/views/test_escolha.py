...
def test_filter_candidato_uuid(api_client: Any) -> None:
    ...
    vaga_escola_1 = VagasEscolas.objects.create(escola=escola, lote=lote, data_fechamento_modulo='2025-01-01', cargo_codigo=100, cargo_descricao='Cargo Teste', vagas_precarias=2, vagas_precarias_restantes=2, vagas_definitivas=5, vagas_definitivas_restantes=5, status='1')
    vaga_escola_2 = VagasEscolas.objects.create(escola=escola, lote=lote, data_fechamento_modulo='2025-01-01', cargo_codigo=101, cargo_descricao='Cargo Teste 2', vagas_precarias=2, vagas_precarias_restantes=2, vagas_definitivas=5, vagas_definitivas_restantes=5, status='1')
    selecionada = Escolha.objects.create(candidato_uuid=uuid.uuid4(), situacao=SituacaoChoices.ESCOLHA, tipo_vaga=TipoVagaChoices.DEFINITIVA, e_retardatario=False, vaga_escola=vaga_escola_1)
    Escolha.objects.create(candidato_uuid=uuid.uuid4(), situacao=SituacaoChoices.NAO_ESCOLHA, tipo_vaga=TipoVagaChoices.PRECARIA, e_retardatario=False, vaga_escola=vaga_escola_2)
    url = reverse('escolha-list')
...
def test_busca_por_candidatos(api_client: Any) -> None:
    ...
    vaga_escola_1 = VagasEscolas.objects.create(escola=escola, lote=lote, data_fechamento_modulo='2025-01-01', cargo_codigo=100, cargo_descricao='Cargo Teste', vagas_precarias=2, vagas_precarias_restantes=2, vagas_definitivas=5, vagas_definitivas_restantes=5, status='1')
    vaga_escola_2 = VagasEscolas.objects.create(escola=escola, lote=lote, data_fechamento_modulo='2025-01-01', cargo_codigo=101, cargo_descricao='Cargo Teste 2', vagas_precarias=2, vagas_precarias_restantes=2, vagas_definitivas=5, vagas_definitivas_restantes=5, status='1')
    vaga_escola_3 = VagasEscolas.objects.create(escola=escola, lote=lote, data_fechamento_modulo='2025-01-01', cargo_codigo=102, cargo_descricao='Cargo Teste 3', vagas_precarias=2, vagas_precarias_restantes=2, vagas_definitivas=5, vagas_definitivas_restantes=5, status='1')
    escolha_1 = Escolha.objects.create(candidato_uuid=uuid.uuid4(), situacao=SituacaoChoices.ESCOLHA, tipo_vaga=TipoVagaChoices.DEFINITIVA, e_retardatario=False, vaga_escola=vaga_escola_1)
    escolha_2 = Escolha.objects.create(candidato_uuid=uuid.uuid4(), situacao=SituacaoChoices.RECONVOCACAO, tipo_vaga=TipoVagaChoices.PRECARIA, e_retardatario=True, vaga_escola=vaga_escola_2)
    Escolha.objects.create(candidato_uuid=uuid.uuid4(), situacao=SituacaoChoices.NAO_ESCOLHA, tipo_vaga=TipoVagaChoices.DEFINITIVA, e_retardatario=False, vaga_escola=vaga_escola_3)
    url = reverse('escolha-busca')
    payload = {'candidato_uuid': [str(escolha_1.candidato_uuid), str(escolha_2.candidato_uuid)]}
    response = api_client.post(url, payload, format='json')
    assert response.status_code == status.HTTP_200_OK
...
def test_create_escolha_decrementa_vaga_definitiva(api_client: Any) -> None:
    ...
    escola = Escola.objects.create(codigo_eol='000001', nome_oficial='Escola Teste', dre=dre, cep='04001-000')
    lote = VagasEscolasLote.objects.create(processo_uuid=uuid.uuid4(), processo_nome='Proc')
    vaga_escola = VagasEscolas.objects.create(escola=escola, lote=lote, data_fechamento_modulo='2025-01-01', cargo_codigo=100, cargo_descricao='Cargo Teste', vagas_precarias=2, vagas_precarias_restantes=2, vagas_definitivas=5, vagas_definitivas_restantes=5, status='1')
    vaga_escola.refresh_from_db()
    vagas_definitivas_inicial = vaga_escola.vagas_definitivas_restantes
    url = reverse('escolha-list')
    payload = {'candidato_uuid': str(uuid.uuid4()), 'concurso_uuid': str(uuid.uuid4()), 'situacao': SituacaoChoices.ESCOLHA, 'tipo_vaga': TipoVagaChoices.DEFINITIVA, 'e_retardatario': False, 'vaga_escola_uuid': str(vaga_escola.uuid)}
...
def test_create_escolha_decrementa_vaga_precaria(api_client: Any) -> None:
    ...
    lote = VagasEscolasLote.objects.create(processo_uuid=uuid.uuid4(), processo_nome='Proc')
    vaga_escola = VagasEscolas.objects.create(escola=escola, lote=lote, data_fechamento_modulo='2025-01-01', cargo_codigo=101, cargo_descricao='Cargo Teste 2', vagas_precarias=3, vagas_precarias_restantes=3, vagas_definitivas=4, vagas_definitivas_restantes=4, status='1')
    vaga_escola.refresh_from_db()
    vagas_precarias_inicial = vaga_escola.vagas_precarias_restantes
    url = reverse('escolha-list')
    payload = {'candidato_uuid': str(uuid.uuid4()), 'concurso_uuid': str(uuid.uuid4()), 'situacao': SituacaoChoices.ESCOLHA, 'tipo_vaga': TipoVagaChoices.PRECARIA, 'e_retardatario': False, 'vaga_escola_uuid': str(vaga_escola.uuid)}
    response = api_client.post(url, payload)
    assert response.status_code == status.HTTP_201_CREATED
    vaga_escola.refresh_from_db()
...
def test_create_escolha_nao_escolha_nao_decrementa(api_client: Any) -> None:
    ...
    lote = VagasEscolasLote.objects.create(processo_uuid=uuid.uuid4(), processo_nome='Proc')
    vaga_escola = VagasEscolas.objects.create(escola=escola, lote=lote, data_fechamento_modulo='2025-01-01', cargo_codigo=102, cargo_descricao='Cargo Teste 3', vagas_precarias=2, vagas_precarias_restantes=2, vagas_definitivas=5, vagas_definitivas_restantes=5, status='1')
    vaga_escola.refresh_from_db()
    vagas_definitivas_inicial = vaga_escola.vagas_definitivas_restantes
    vagas_precarias_inicial = vaga_escola.vagas_precarias_restantes
    url = reverse('escolha-list')
    payload = {'candidato_uuid': str(uuid.uuid4()), 'concurso_uuid': str(uuid.uuid4()), 'situacao': SituacaoChoices.NAO_ESCOLHA, 'tipo_vaga': TipoVagaChoices.DEFINITIVA, 'e_retardatario': False, 'vaga_escola_uuid': str(vaga_escola.uuid)}
    response = api_client.post(url, payload)
    assert response.status_code == status.HTTP_201_CREATED
    vaga_escola.refresh_from_db()
...
def test_agrupar_por_cargo_retorna_dict_so_com_situacao_escolha(api_client: Any) -> None:
    ...
    lote = VagasEscolasLote.objects.create(processo_uuid=uuid.uuid4(), processo_nome='Proc')
    vaga_cargo_100 = VagasEscolas.objects.create(escola=escola, lote=lote, data_fechamento_modulo='2025-01-01', cargo_codigo=100, cargo_descricao='Cargo 100', vagas_precarias=0, vagas_precarias_restantes=0, vagas_definitivas=10, vagas_definitivas_restantes=10, status='1')
    vaga_cargo_101 = VagasEscolas.objects.create(escola=escola, lote=lote, data_fechamento_modulo='2025-01-01', cargo_codigo=101, cargo_descricao='Cargo 101', vagas_precarias=0, vagas_precarias_restantes=0, vagas_definitivas=10, vagas_definitivas_restantes=10, status='1')
    Escolha.objects.create(candidato_uuid=uuid.uuid4(), situacao=SituacaoChoices.ESCOLHA, tipo_vaga=TipoVagaChoices.DEFINITIVA, e_retardatario=False, vaga_escola=vaga_cargo_100)
    Escolha.objects.create(candidato_uuid=uuid.uuid4(), situacao=SituacaoChoices.ESCOLHA, tipo_vaga=TipoVagaChoices.DEFINITIVA, e_retardatario=False, vaga_escola=vaga_cargo_100)
    Escolha.objects.create(candidato_uuid=uuid.uuid4(), situacao=SituacaoChoices.NAO_ESCOLHA, tipo_vaga=TipoVagaChoices.DEFINITIVA, e_retardatario=False, vaga_escola=vaga_cargo_100)
    Escolha.objects.create(candidato_uuid=uuid.uuid4(), situacao=SituacaoChoices.ESCOLHA, tipo_vaga=TipoVagaChoices.PRECARIA, e_retardatario=False, vaga_escola=vaga_cargo_101)
...
def test_reconvocacao_endpoint(api_client: Any) -> None:
    ...
    lote = VagasEscolasLote.objects.create(processo_uuid=uuid.uuid4(), processo_nome='Proc')
    vaga_escola = VagasEscolas.objects.create(escola=escola, lote=lote, data_fechamento_modulo='2025-01-01', cargo_codigo=100, cargo_descricao='Cargo Teste', vagas_precarias=2, vagas_precarias_restantes=2, vagas_definitivas=5, vagas_definitivas_restantes=5, status='1')
    escolha_reconvocacao = Escolha.objects.create(candidato_uuid=uuid.uuid4(), situacao=SituacaoChoices.RECONVOCACAO, tipo_vaga=TipoVagaChoices.DEFINITIVA, e_retardatario=False, vaga_escola=vaga_escola)
    Escolha.objects.create(candidato_uuid=uuid.uuid4(), situacao=SituacaoChoices.ESCOLHA, tipo_vaga=TipoVagaChoices.DEFINITIVA, e_retardatario=False, vaga_escola=vaga_escola)
...
def test_importacao_prodam_sucesso(api_client: Any, settings: Any) -> None:
    ...
    dre = Dre.objects.create(codigo='01', nome='DRE 01', sigla='DRE-01')
    escola = Escola.objects.create(codigo_eol='123456', nome_oficial='Escola Teste', dre=dre, cep='04001-000')
    lote = VagasEscolasLote.objects.create(processo_uuid=uuid.uuid4(), processo_nome='Proc')
    VagasEscolas.objects.create(escola=escola, lote=lote, data_fechamento_modulo='2025-01-01', cargo_codigo=100, cargo_descricao='Cargo Teste', vagas_precarias=2, vagas_precarias_restantes=2, vagas_definitivas=5, vagas_definitivas_restantes=5, status='1')
    processo_uuid = uuid.uuid4()
    concurso_uuid = uuid.uuid4()
    candidato_uuid = uuid.uuid4()
    mock_candidatos = [{'uuid': str(candidato_uuid), 'cpf': '12345678901', 'nome': 'Candidato Teste'}]
    payload = {'concurso_uuid': str(concurso_uuid), 'processo_uuid': str(processo_uuid), 'escolhas': [{'cpf': '12345678901', 'codigo_cargo': '100', 'codigo_eol': '123456', 'tipo_vaga': 'D', 'situacao': 'ESCOLHA'}]}
...
def test_importacao_prodam_multiplas_escolhas(api_client: Any, settings: Any) -> None:
    ...
    mock_candidatos = [{'uuid': str(candidato_uuid_1), 'cpf': '12345678901', 'nome': 'Candidato 1'}, {'uuid': str(candidato_uuid_2), 'cpf': '98765432100', 'nome': 'Candidato 2'}]
    payload = {'concurso_uuid': str(concurso_uuid), 'processo_uuid': str(processo_uuid), 'escolhas': [{'cpf': '12345678901', 'codigo_cargo': '100', 'codigo_eol': '123456', 'tipo_vaga': 'D', 'situacao': 'ESCOLHA'}, {'cpf': '98765432100', 'codigo_cargo': '100', 'codigo_eol': '123456', 'tipo_vaga': 'P', 'situacao': 'NAO-ESCOLHA'}]}
    with patch('escolhas.views.escolha.CandidatoAPIService') as mock_service_class:
        mock_service = Mock()
        mock_service.buscar_candidatos_por_cpfs.return_value = mock_candidatos
        mock_service_class.return_value = mock_service
...
def test_importacao_prodam_mapeamento_situacao(api_client: Any, settings: Any) -> None:
    ...
    candidato_uuid = uuid.uuid4()
    mock_candidatos = [{'uuid': str(candidato_uuid), 'cpf': '12345678901', 'nome': 'Candidato Teste'}]
    situacoes_teste = [('ESCOLHA', SituacaoChoices.ESCOLHA), ('NAO-ESCOLHA', SituacaoChoices.NAO_ESCOLHA), ('RECONVOCACAO', SituacaoChoices.RECONVOCACAO), ('PENDENTE', SituacaoChoices.NAO_ESCOLHA), ('INVALIDO', SituacaoChoices.NAO_ESCOLHA)]
    for situacao_input, situacao_esperada in situacoes_teste:
        payload = {'concurso_uuid': str(concurso_uuid), 'processo_uuid': str(processo_uuid), 'escolhas': [{'cpf': '12345678901', 'codigo_cargo': '100', 'codigo_eol': '', 'situacao': situacao_input}]}
        with patch('escolhas.views.escolha.CandidatoAPIService') as mock_service_class:
            mock_service = Mock()
            mock_service.buscar_candidatos_por_cpfs.return_value = mock_candidatos
            mock_service_class.return_value = mock_service
...
def test_importacao_prodam_mapeamento_tipo_vaga(api_client: Any, settings: Any) -> None:
    ...
    candidato_uuid = uuid.uuid4()
    mock_candidatos = [{'uuid': str(candidato_uuid), 'cpf': '12345678901', 'nome': 'Candidato Teste'}]
    tipos_teste = [('P', TipoVagaChoices.PRECARIA), ('D', TipoVagaChoices.DEFINITIVA), ('p', TipoVagaChoices.PRECARIA), ('d', TipoVagaChoices.DEFINITIVA), ('X', None)]
    for tipo_input, tipo_esperado in tipos_teste:
        payload = {'concurso_uuid': str(concurso_uuid), 'processo_uuid': str(processo_uuid), 'escolhas': [{'cpf': '12345678901', 'codigo_cargo': '100', 'codigo_eol': '', 'tipo_vaga': tipo_input, 'situacao': 'ESCOLHA'}]}
        with patch('escolhas.views.escolha.CandidatoAPIService') as mock_service_class:
            mock_service = Mock()
            mock_service.buscar_candidatos_por_cpfs.return_value = mock_candidatos
            mock_service_class.return_value = mock_service
...
def test_importacao_prodam_escolha_sem_codigo_eol(api_client: Any, settings: Any) -> None:
    ...
    candidato_uuid = uuid.uuid4()
    mock_candidatos = [{'uuid': str(candidato_uuid), 'cpf': '12345678901', 'nome': 'Candidato Teste'}]
    payload = {'concurso_uuid': str(concurso_uuid), 'processo_uuid': str(processo_uuid), 'escolhas': [{'cpf': '12345678901', 'codigo_cargo': '100', 'codigo_eol': '', 'situacao': 'NAO-ESCOLHA'}]}
    with patch('escolhas.views.escolha.CandidatoAPIService') as mock_service_class:
        mock_service = Mock()
        mock_service.buscar_candidatos_por_cpfs.return_value = mock_candidatos
        mock_service_class.return_value = mock_service
...
def test_buscar_candidatos_com_parametro_retorna_200(api_client: Any) -> None:
    ...
    with patch('escolhas.views.escolha.CandidatoAPIService') as mock_service_class:
        ...
        mock_service.buscar_candidatos.assert_called_once_with(nome='João', cpf=None, rg=None, registro_funcional=None)
...
def test_list_escolhas_inclui_campo_historico(api_client: Any, escolha_matematica: Any) -> None:
    ...
    assert response.status_code == status.HTTP_200_OK
    assert response.data['count'] >= 1
    resultado = next((r for r in response.data['results'] if str(r['candidato_uuid']) == str(escolha_matematica.candidato_uuid)), None)
