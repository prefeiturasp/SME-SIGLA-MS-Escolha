...
class HistoricoEscolha(BaseModel):
    ...
    escolha = models.ForeignKey('Escolha', on_delete=models.CASCADE, related_name='historico', verbose_name=_('Escolha'))
    situacao_anterior = models.CharField(max_length=20, choices=SituacaoChoices.choices, blank=True, null=True, verbose_name=_('Situação Anterior'))
    situacao_nova = models.CharField(max_length=20, choices=SituacaoChoices.choices, verbose_name=_('Situação Nova'))
