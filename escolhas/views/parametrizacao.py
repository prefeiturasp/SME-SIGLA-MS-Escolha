...
from ..serializers import ParametrizacaoSerializer, ParametrizacaoBulkItemSerializer
...
class ParametrizacaoViewSet(mixins.ListModelMixin,
    ...
    def sync(self, request):
        """
        Opcional: sincroniza registros a partir dos tipo_ue distintos em Escola.
        """
    ...
    def bulk_update(self, request):
        """
        Atualiza múltiplos registros apenas no campo 'usar', recebendo uma lista de objetos:
        [
          {"uuid": "<uuid>", "usar": true},
        ...
        # Mapeia uuid -> usar, somente quando 'usar' foi explicitamente informado
