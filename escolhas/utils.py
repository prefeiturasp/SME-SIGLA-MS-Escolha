...
class CustomPagination(PageNumberPagination):
    ...
    def get_paginated_response(self, data: Any) -> Any:
        ...
        return Response({'links': {'next': self.get_next_link(), 'previous': self.get_previous_link()}, 'count': self.page.paginator.count, 'page': page, 'page_size': page_size, 'results': data})  # type: ignore[has-type]
